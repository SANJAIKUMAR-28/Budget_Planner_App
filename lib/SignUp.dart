import 'package:budget_planner/user_model.dart';
    ...
    return Scaffold(
      ...
      Column(
          ...
          children:[
            ...
            SizedBox(height: 2,),
            Text('Welcome to BudgetPlanner',style: TextStyle(fontSize: 12,fontFamily: 'Arimo',fontWeight: FontWeight.w100,color: Colors.black45),textAlign: TextAlign.left,)
          ]
      ),
        centerTitle: false,
        elevation: 0.0,
